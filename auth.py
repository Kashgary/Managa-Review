...
AUTH0_DOMAIN = 'kashgary1.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'mangareview'
...
def get_token_auth_header():
    ...
    # if auth doesn't contain bearer
